...
/**
 * @author dream_tree
 * This class consists of methods allowing to display the application.
 */
...
public class ClockDisplayJavaFX extends Application {
    ...
    /**
	  * Creates the content of Scene container.
	  */ 
    public Parent createContent() {
        ...
        group.selectedToggleProperty().addListener((ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle selectedToggle) -> {
            ...
            if (selectedToggle == tb2) { 
            	// Clock instance and Runnable block inside group.selectedToggleProperty()... to display new time every click. 
                Clock clock = new Clock();        
                Runnable r = () ->  { 
                	try {
                	clock.createPath();
